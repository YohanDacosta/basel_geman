    ...
    <div className="p-4 bg-[rgba(235,234,234,1)] md:flex md:items-center md:space-x-12 rounded-2xl">
      <div className="flex flex-col space-y-0.5 px-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          <p className="bg-violet-200 font-mono text-sm rounded-full px-3 py-1">
            {course.school}
          </p>
        </div>
        <div className="flex items-center space-x-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          <strong className="font-semibold text-xs">Anzahl Lektionen:</strong>{" "}
        ...
        {course.registration_deadline !== "" ? (
          <div className="flex items-center space-x-2">
            ...
            <p className="font-mono text-sm rounded-full bg-red-200 px-4 py-1">
              {course.registration_deadline}
            </p>
          </div>
        ) : (
